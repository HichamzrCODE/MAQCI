...
<div class="container">
    <h2 style="margin-top: 30px;">Relevé <?= htmlspecialchars($client['nom']) ?></h2>
    <a href="index.php?action=releve/extrait&id=<?= $releve['id'] ?>" class="btn btn-secondary mb-3">Filtrer par période</a>
    ...
    <a href="index.php?action=releve" class="btn btn-outline-primary mt-2">Retour</a>
