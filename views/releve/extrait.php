...
<div class="container">
    <h2 style="margin-top:30px;">Relevé <?= htmlspecialchars($client['nom']) ?> <span class="text-secondary" style="font-size:1rem;">(Extrait)</span></h2>
    <form method="get" class="releve-dates mb-3 row g-2">
        <input type="hidden" name="action" value="releve/extrait">
    ...
    <a href="index.php?action=releve/show&id=<?= $releve['id'] ?>" class="btn btn-outline-primary mt-2">Voir tout le relevé</a>
    <a href="index.php?action=releve" class="btn btn-outline-secondary mt-2">Retour à la liste</a>
